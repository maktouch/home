			...
			<Section title="Side Projects / Open Source">
				<Timeline>
					...
					<TimelineItem
						...
						subtitle="2023-2024"
					>
						Generate zod types from your database, for complete type safety with
						Kysely
					</TimelineItem>
					<TimelineItem
						...
						subtitle="2023"
					>
						Finance.ts makes it easy to incorporate common financial
						calculations into your application
					</TimelineItem>
					<TimelineItem
